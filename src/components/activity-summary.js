...
export default function ActivitySummary({ date, refreshKey }) {
  ...
  return (
    <div className="bg-[var(--surface)] rounded-3xl border border-[var(--border)] p-5 flex items-center">
      <div className="flex-1 flex items-center gap-3">
        ...
        <div>
          <p className="text-lg font-black text-[var(--text-primary)]">{active.toLocaleString()}</p>
          <p className="text-[9px] font-bold text-[var(--text-tertiary)] uppercase tracking-wider">Active kcal</p>
        </div>
      </div>
      <div className="w-px h-8 bg-[var(--surface-2)]" />
      <div className="flex-1 flex items-center gap-3 justify-end">
        <div>
          <p className="text-lg font-black text-[var(--text-primary)] text-right">{steps.toLocaleString()}</p>
          <p className="text-[9px] font-bold text-[var(--text-tertiary)] uppercase tracking-wider text-right">Steps</p>
        </div>
